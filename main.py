...
def main():
    ...
    try:
        ...
        plotAllzjlx()
        print(datetime.datetime.now(timezone).strftime("%H:%M:%S"), 'refreshed.')

        while (datetime.datetime.now(timezone).strftime("%H%M")>='0930' and datetime.datetime.now(timezone).strftime("%H%M")<='1501'):
            if (datetime.datetime.now(timezone).strftime("%H%M")>'1130' and datetime.datetime.now(timezone).strftime("%H%M")<'1300'):
                print(datetime.datetime.now(timezone).strftime("%H:%M:%S"),'sleep 60s')
                time.sleep(60)
            else:
                plotAllzjlx()
                print(datetime.datetime.now(timezone).strftime("%H:%M:%S"), 'refreshed.')
